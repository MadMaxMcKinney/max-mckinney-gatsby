...
export const SocialButton = (props) => {
    return (
        <a href={props.href} target={props.accent} rel={props.rel} className={`grid place-items-center transition-all text-xl no-underline text-zinc-300 hover:opacity-70`}>
            {props.children}
        </a>
    );
};
