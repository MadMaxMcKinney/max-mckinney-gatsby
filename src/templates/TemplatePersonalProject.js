...
const SideProjectDetailView = ({ data }) => (
    <React.Fragment>
        ...
        <div className="page-grid">
            ...
            <div className="prose prose-lg max-w-none text-zinc-400 mt-16 animate-fade-in-very-slow [&_img]:rounded-sm [&_p]:opacity-85" dangerouslySetInnerHTML={{ __html: data.personal.html }} />
        </div>
    </React.Fragment>
);
...
export const query = graphql`
    query PersonalProjectBySlug($id: String!) {
        site {
            siteMetadata {
                title
                siteUrl
        ...
        personal: markdownRemark(id: { eq: $id }) {
            frontmatter {
                title
                description
                locationText
