...
const GetSumPrivacyPage = ({ data }) => (
    <div className="page-grid">
        <img
            className="w-24 h-24 mb-4 mt-44 rounded-full animate-fade-in-very-slow"
            src={GetSumLogo}
        />
        <PageHeaderTitle className="animate-fade-in-slow">
            Get Sum - Privacy Policy
        </PageHeaderTitle>
        <PageSubtitle className="animate-fade-in-slow">
            TLDR: I only collect the analytics that Apple automatically gives
            developers, nothing more. The app just counts things. That's it.
        </PageSubtitle>
        ...
        <div className="mt-16 animate-fade-in">
            ...
            <p>
                Thank you for choosing to be part of our community at Timothy
                McKinney (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;,
                ...
                <a href="mailto:maxmckinney@hey.com">maxmckinney@hey.com</a>.
            </p>
            <p>
                When you use our mobile application, as the case may be (the
                &quot;App&quot;) and more generally, use any of our services
            ...
            <p>
                ...
                our Services (which, as described above, includes our App), as
            ...
            <p>
                ...
                &mdash; is collected automatically when you visit our App.
            </p>
            <p>
            ...
            <p>
                ...
                and settings of the device you use to access the App. For
            ...
            <p>
                ...
                our App is at your own risk. You should only access the App
            ...
            <p>
                ...
                details here:{" "}
                <a className="underline" href="http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm">
            ...
            <h1>9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h1>
            <p>
            ...
            <p>
                ...
                a registered account with the App, you have the right to request
            ...
            <h1>10. DO WE MAKE UPDATES TO THIS NOTICE? &nbsp; &nbsp;&nbsp;</h1>
            <p>
            ...
            <p>
                ...
                email us at{" "}
                <a className="underline" href="mailto:maxmckinney@hey.com">maxmckinney@hey.com</a> or
                by post to:
            </p>
            <p>Timothy McKinney, PO Box 406, Liberty Hill, TX, 78642, USA</p>
            <h1>
            ...
            <p>
                ...
                <a className="underline" href="mailto:maxmckinney@hey.com">maxmckinney@hey.com</a>. We
                will respond to your request within 30 days.
            </p>
            <p>
                This privacy policy was created using Termly&rsquo;s Privacy
                Policy Generator.
            </p>
        </div>
    </div>
...
export default GetSumPrivacyPage;
