...
const IndexPage = ({ data }) => (
    <React.Fragment>
        <div className="px-6">
            <div className="flex items-end relative pt-40 pb-16" id="Header">
                <div className="contained-content z-10">
            ...
            <div className="contained-content mt-16 animate-fade-in-slow sm:mt-24" id="BioDescription">
                <div className="text-gray-400">
                    <MBodyLead className="mb-6">
                        I’m <span className="text-transparent bg-gradient-to-r from-max-red-300 via-max-purple-300 to-max-pink-300 bg-clip-text bg-300% animate-flow-background">Max McKinney</span>.
