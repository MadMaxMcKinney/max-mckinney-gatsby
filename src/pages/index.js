  ...
  <React.Fragment>
	  <PageGrid>
        ...
        <div className="hidden md:block">
            <h1 className="hidden mb-24 text-xl text-white leading-relaxed animate-fade-in md:block">I’m <HeaderPill showProfile title="Max McKinney" /> currently a design lead at <HeaderPill type="ibm" title="IBM" /><br/>My background is in <HeaderPill type="uiux" title="UI/UX Design" /> and <HeaderPill type="development" title="Web Development" /><br/>A decade of creating allows me to make <HeaderPill type="experience" title="Seamless Experiences" /></h1>
        </div>

        {/* Mobile Text */}
        <div className="block md:hidden">
            <h1 className="block mb-24 text-xl text-white leading-relaxed animate-fade-in md:hidden">I’m <HeaderPill showProfile title="Max McKinney" /><br/>currently a design lead at <HeaderPill type="ibm" title="IBM" /><br/>My background is in <br/><HeaderPill type="uiux" title="UI/UX Design" /> <HeaderPill type="development" title="Web Dev" /><br/>A decade of creating lets me make <HeaderPill type="experience" title="Seamless Experiences" /></h1>
        </div>
        ...
        {/* Project Card Grid */}
		<div className="animate-fade-in grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-1 lg:gap-24">
